...
PRODUCT_PACKAGE_OVERLAYS += device/intex/Cloud_Q11/overlay # enable this to be able overlay a default wallpaper
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/system/etc/permissions/android.hardware.sensor.gyroscope.xml:system/etc/permissions/android.hardware.sensor.gyroscope.xml \
